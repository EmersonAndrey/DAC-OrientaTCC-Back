...
public class SpringSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/trabalhoAcademico/matricula/{matricula}").permitAll()
    ...
    public PasswordEncoder passwordEncoder() {
        return new BCryptPasswordEncoder(); //classe referente ao tipo de criptografia que sera utilizada q é a BCrypt atualmente ela é considerada a criptografia mais segura,
                                            // usando ela a cada vez q uma senha é criptografada é criada uma nova criptografia dIferente para a senha,
